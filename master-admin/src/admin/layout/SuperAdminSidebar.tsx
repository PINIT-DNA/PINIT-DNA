...
const NAV: { to: string; label: string; icon: typeof LayoutDashboard; end?: boolean; domain: AdminDomain }[] = [
  { to: '/', label: 'Command Center', icon: LayoutDashboard, end: true, domain: 'overview' },
  { to: '/users', label: 'Users', icon: Users, domain: 'identity' },
  { to: '/organizations', label: 'Organizations', icon: Building2, domain: 'identity' },
  { to: '/dna', label: 'Assets & DNA', icon: Boxes, domain: 'assets' },
  { to: '/investigations', label: 'Intelligence (Sentinel)', icon: ShieldCheck, domain: 'forensics' },
  { to: '/marketplace', label: 'Marketplace (Exchange)', icon: ShoppingCart, domain: 'commerce' },
  { to: '/billing', label: 'Billing & Subscriptions', icon: CreditCard, domain: 'commerce' },
  { to: '/credits', label: 'Credits & Usage', icon: Coins, domain: 'commerce' },
  { to: '/network', label: 'Network Intelligence', icon: Share2, domain: 'intelligence' },
  { to: '/monitoring', label: 'Web Intelligence / Crawler', icon: Globe2, domain: 'operations' },
  { to: '/verification', label: 'Identity & Verification', icon: Fingerprint, domain: 'identity' },
  { to: '/support', label: 'Support & Disputes', icon: LifeBuoy, domain: 'system' },
  { to: '/analytics', label: 'Reports & Analytics', icon: BarChart3, domain: 'intelligence' },
  { to: '/settings', label: 'System & Settings', icon: Settings2, domain: 'system' },
];
