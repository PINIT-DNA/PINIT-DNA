          ...
          {org.identity && (
            <section className="bg-white border border-gray-200 rounded-xl p-4 md:col-span-2">
              ...
              <p className="text-xs text-gray-500 mb-3">
                Every label this organization can appear under across the platform.
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ['Root (biometric)', org.identity.root],
                  ['Individual', org.identity.individual],
                  ['Business', org.identity.business],
                  ['Exchange', org.identity.exchange],
                ].map(([label, id]) => (
