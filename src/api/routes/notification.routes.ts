...
import { getNotifications, markRead, markAllRead, clearInbox, archiveNotification, deleteNotification, streamNotifications } from '../controllers/notification.controller';
...
router.put('/clear-inbox',  requireAuth, clearInbox);
